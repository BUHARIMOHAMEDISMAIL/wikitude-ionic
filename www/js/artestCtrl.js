nodewithionic.controller('artestCtrl', function($scope, $http, ajaxService, $ionicModal, $cordovaFile, $cordovaFileTransfer, $cordovaCamera) {
    console.log('artestCtrl is working');
    var World = {
	loaded: false,
